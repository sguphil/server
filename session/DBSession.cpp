#include "DBSession.h"
#include "../DBSvr/include/SessionHandler.hpp"
...
#if 0
int32 DBSession::testRefectSvr(char *msgbuf, int32 bufsize)
{
...
int32 DBSession::testRefectSvr(MsgHeader *msghead, char *msgbuf, int32 bufsize)
{
...
int32 DBSession::testProtobuf(MsgHeader *msghead, char *msgbuf, int32 bufsize)
{
...
#if 0
int32 DBSession::onRecv(PkgHeader *header, char *msgbuf, int32 buffsize)
{
    MsgHeader *msghead = (MsgHeader *)msgbuf;
...
int32 DBSession::onRecv(PkgHeader *header, MsgHeader *msghead, char *msgbuf, int32 buffsize)
{
    int16 sysid = msghead->sysId;
    int16 msgtype = msghead->msgType;
    if (sysid == 1 and msgtype == 2)
